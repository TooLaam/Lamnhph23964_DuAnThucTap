                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <c:forEach items="${listCategory}" var="loai">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/category/delete/${loai.id}" class="btn btn-danger" onclick="return confirm('Bạn chắc chắn có muốn xóa??')" style="text-decoration: none;color: white"><i class='bx bx-trash'></i></a>
                                            <a href="/category/detail/${loai.id}" class="btn btn-success" style="text-decoration: none;color: white; margin-top: 5px" ><i class='bi bi-arrow-repeat'></i></a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
